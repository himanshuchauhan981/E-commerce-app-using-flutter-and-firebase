...
class AdminService {
  ...
  CollectionReference _categoryReference = FirebaseFirestore.instance.collection('categories');
  CollectionReference _subCategoryReference = FirebaseFirestore.instance.collection('subCategories');
  ...
  void createSampleData() {
    ...
    loadAsset('assets/csv/CATEGORY_MOCK_DATA.csv').then(
      (dynamic value) async {
        ...
        loadAsset('assets/csv/PRODUCTS_MOCK_DATA.csv').then(
          (dynamic value) async {
